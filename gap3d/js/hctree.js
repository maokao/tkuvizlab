...
var wasmBinaryFile = 'hctree.wasm';
...
var real__hctree_sort = asm["_hctree_sort"];
asm["_hctree_sort"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__hctree_sort.apply(null, arguments);
};
...
var _hctree_sort = Module["_hctree_sort"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_hctree_sort"].apply(null, arguments)
};
